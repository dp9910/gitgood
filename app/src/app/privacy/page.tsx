...
import { PRIVACY_SECTIONS, PRIVACY_LAST_UPDATED, getTableOfContents } from "@/lib/legal";

export default function PrivacyPage() {
  const toc = getTableOfContents(PRIVACY_SECTIONS);

  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950" data-testid="privacy-page">
      {/* Header */}
      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="mt-16 pt-8 border-t border-slate-200 dark:border-slate-800">
          <p className="text-sm text-slate-500">
            ...
            <a href="mailto:privacy@gitgood.dev" className="text-primary hover:underline">
              privacy@gitgood.dev
            </a>
          </p>
        </div>
